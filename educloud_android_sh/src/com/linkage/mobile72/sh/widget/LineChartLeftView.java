...
public class LineChartLeftView extends GraphicalView
{
    ...
    public LineChartLeftView(Context context)
    {
        super(context);
    ...
    public LineChartLeftView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        chartLabels();
        chartDataSet();
    ...
    public LineChartLeftView(Context context, AttributeSet attrs, int defStyle)
    {
...
//            chart.getDataAxis().hideTickMarks();
    ...
    private void chartDataSet()
    {
        ...
        LineData lineData3 = new LineData("", dataSeries3, Color.rgb(123,
                89,
                168));
        ...
        //        LineData lineData4 = new LineData("",dataSeries4,Color.rgb(84, 206, 231));
        ...
        //        LineData lineData5 = new LineData("",valuesE,Color.rgb(234, 142, 43));
