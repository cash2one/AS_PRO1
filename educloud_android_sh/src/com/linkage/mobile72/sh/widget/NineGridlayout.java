...
public class NineGridlayout extends ViewGroup {
    ...
    public NineGridlayout(Context context) {
        super(context);
        imageList = new ArrayList<ClazzImage>();
    }
    ...
    public void setImagesData(ClazzTalk talk) {
    	imageList.clear();
    	List<Image> lists = talk.getPicImages();
    	...
    	for(int i = 0;i < lists.size();i++){
    		...
    		String[] subPicUri = talk.getPicUrl().get(i).split("_small");
