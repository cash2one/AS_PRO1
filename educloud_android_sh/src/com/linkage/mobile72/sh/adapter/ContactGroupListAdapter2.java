...
public class ContactGroupListAdapter2 extends BaseAdapter {
	...
	public ContactGroupListAdapter2(Context context, Handler mHandler, ImageLoader imageLoader_group,
...
//						mContext.startActivity(intent);
						...
						bundle.putString("chatid", Consts.APP_ID0 + ((ClassRoom) obj).getId()+"");
