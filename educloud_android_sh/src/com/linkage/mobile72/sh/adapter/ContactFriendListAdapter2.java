...
public class ContactFriendListAdapter2 extends BaseAdapter {
	...
	public ContactFriendListAdapter2(Context context, Handler mHandler, ImageLoader imageLoader,
...
//							EventBus.getDefault().post(new ContactsEvent(1));
		...
		BaseApplication.getInstance().addToRequestQueue(mRequest, ContactsFriendFragment2.TAG);
	}
}