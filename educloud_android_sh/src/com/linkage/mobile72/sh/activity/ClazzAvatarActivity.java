...
public class ClazzAvatarActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		clazzImage = (ImageView)findViewById(R.id.clazz_avater);
		imageLoader_group.displayImage(Consts.SERVER_HOST + clazz.getAvatar(), clazzImage);
		clazzImage.setOnClickListener(this);
	...
	private void setPicToView(Intent picdata) {  
        ...
        if (extras != null) {  
            ...
            clazzImage.setImageDrawable(drawable);
        }  
    }
    ...
    private void sumbitAccountInfo() {
    	...
    	params.add(new ParamItem("classroomName", clazz.getClassroomName(), ParamItem.TYPE_TEXT));
		if(file != null) {
	    	...
	    	WDJsonObjectMultipartRequest mRequest = new WDJsonObjectMultipartRequest(Consts.SERVER_URL, Request.Method.POST, params, true, new Response.Listener<JSONObject>() {
	    		...
	    		public void onResponse(JSONObject response) {
	    			...
	    			if (response.optInt("ret") == 0) {
	    				...
	    				clazz.setClassroomName(clazz.getClassroomName());
	    				...
	    				StatusUtils.handleStatus(response, ClazzAvatarActivity.this);
	    			}
	    		}
	    		...
	    		public void onErrorResponse(VolleyError arg0) {
	    			ProgressDialogUtils.dismissProgressBar();
					StatusUtils.handleError(arg0, ClazzAvatarActivity.this);
	    		}
	    	});
