...
public class JxHomeworkListActivity3 extends BaseActivity implements View.OnClickListener {
	private static final String TAG = JxHomeworkListActivity3.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (TextUtils.equals(mSmsMessageType, SMSMESSAGETYPE_HOMEWORK)) {
            ...
            mSmsMessageType = SMSMESSAGETYPE_NOTICE + "," + SMSMESSAGETYPE_TOUPIAO;
			mSmsMessageStr = "通知";
		} else if (TextUtils.equals(mSmsMessageType, SMSMESSAGETYPE_COMMENT)) {
            mSmsMessageType = SMSMESSAGETYPE_COMMENT;
			mSmsMessageStr = "点评";
		} else if (TextUtils.equals(mSmsMessageType, SMSMESSAGETYPE_SCORE)) {
            mSmsMessageType = SMSMESSAGETYPE_SCORE;
			mSmsMessageStr = "成绩信箱";
		}
...
//		t.set(1, 4, 2014);
		...
		DeleteListener deleteListener = new DeleteListener() {
			...
			public void delete(final int position) {
				mDialog = new MyCommonDialog(JxHomeworkListActivity3.this, "提示消息", "您确定删除该记录？",
						"取消", "确定");
		...
		mAdapter = new JxhdListAdapter(JxHomeworkListActivity3.this,
		...
		mList.setSwipeListViewListener(new BaseSwipeListViewListener() {
			...
			public void onClickFrontView(int position) {
				...
				Intent i = new Intent(JxHomeworkListActivity3.this, mSmsMessageType == SMSMESSAGETYPE_SCORE ? ScoreDetailActivity.class : JxHomeworkDetailActivity3.class);
	...
	private void deleteFile(final JXBean jxBean, final int position) {
		...
		params.put("type", "1");
		params.put("smsMessageType",  String.valueOf(jxBean.getSmsMessageType()));
		...
		WDJsonObjectRequest mRequest = new WDJsonObjectRequest(Consts.SERVER_deleteMessage,
				Request.Method.POST, params, true, new Response.Listener<JSONObject>() {
					...
					public void onResponse(JSONObject response) {
						...
						T.showShort(JxHomeworkListActivity3.this, response.optString("msg"));
					}
				}, new Response.ErrorListener() {
					@Override
					public void onErrorResponse(VolleyError arg0) {
						ProgressDialogUtils.dismissProgressBar();
						StatusUtils.handleError(arg0, JxHomeworkListActivity3.this);
					}
				});
